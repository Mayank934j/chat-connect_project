<?PHP if(!isset($title_text)){$title_text="WELCOME TO CHAT CONNECT&nbsp; ";} $_SESSION["_appName"]="VMS"; if(!isset($sub_title)){$sub_title="&nbsp; ";} if(!isset($basefolder) || $basefolder=='')$basefolder='';   ?>
<style>
.logo-bg{
...
<div class="container">
<div class="row">
    <div  class="col-xs-2" style="padding-top:7px;" id='hdr_img'><img  src="<?PHP echo $basefolder; ?>logo.png" draggable="false" style="max-width:100px; max-height:100px; opacity:.9; " class="img-responsive cil-img_" /></div><div  class="col-xs-10" align="left" ><h1 class="cil-hdr-font1"><?PHP echo $title_text; ?></h1><p class="cil-hdr-font2" ><?PHP echo $sub_title; ?></p></div>
  </div>
  </div>
  </div>
  <script>
