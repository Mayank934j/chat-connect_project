...
<body id="bodypg" style="font-family:'Palatino Linotype', 'Book Antiqua', Palatino, serif; ">
		...
		?>
           ...
           <!-- 📎 Upload Audio/Video Icon -->
<img src="../app/icons/fupload.jpg"
     id="uploadfiles_icon"
     onclick="document.getElementById('xfiles').click();"
     title="Upload Audio/Video"
     style="position: absolute; top:380px; right: 680px; width: 22px; cursor: pointer;">

<!-- 🎧 File Input: Accept only audio/video -->
<input type="file"
       id="xfiles"
       accept="audio/*,video/*"
       data-previewdivid="preview"
       style="display: none;"
       onchange="handleAudioVideoUpload(this)"
       multiple />

<!-- ✅ Add this directly below the input field -->
...
function handleAudioVideoUpload(input) {
  ...
  // ✅ Optionally: send file for transcription or translation later
}
</script>
